    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-xl shadow-sm p-8 max-w-md w-full">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 border border-gray-300 rounded-lg py-2.5 text-sm font-medium hover:bg-gray-50 transition-colors mb-4"
        >
        ...
        <p className="text-center text-sm text-gray-500 mt-6">
          New to REMEDIUM SI?{' '}
          <Link href="/register" className="text-primary-500 font-medium hover:underline">Create account</Link>
        </p>
      </div>
    </div>
  )
